document.addEventListener("DOMContentLoaded", function () {
    ...
    function ercodingValidateTextarea() {
        ...
        if (value.length < 15) {
            ercodingShowError(
                ercodingFormTextarea,
                "Wiadomość powinna mieć co najmniej 15 znaków."
            );
            return false;
        } else {
    ...
    if (ercodingFormSurname) {
        ercodingFormSurname
            .querySelector("input")
            .addEventListener("input", ercodingValidateSurname);
    }
    ...
    if (ercodingFormTextarea) {
        ercodingFormTextarea
            ...
            .addEventListener("input", ercodingValidateTextarea);
    }
