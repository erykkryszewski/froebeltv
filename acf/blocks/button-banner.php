            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="button-banner__content">
                        ...
                        <?php endif; ?> <?php if (!empty($text)): ?> <?php echo apply_filters('acf_the_content', $text); ?> <?php endif; ?>
                    </div>
                </div>
                <?php if (!empty($button)): ?>
                <div class="col-md-6">
                    <div class="button-banner__link-wrapper">
                        <a href="<?php echo esc_html($button['url']); ?>" class="button-banner__button button" target="<?php echo esc_html($button['target']); ?>"><?php echo esc_html($button['title']); ?></a>
                    </div>
                </div>
                <?php endif; ?>
            </div>
