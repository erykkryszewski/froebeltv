        ...
        <div class="hero-slider__wrapper">
            ...
            <div class="hero-slider__item">
                ...
                <div class="hero-slider__image <?php if (!empty($item['button_link'])) { echo 'hero-slider__image--animated'; } ?>">
                    <?php echo wp_get_attachment_image($item['image'], 'hero', '', ['class' => 'object-fit-cover']); ?> <?php if ('true' == $item['overlay']): ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="hero-slider__content <?php if ($full_width == 'true') { echo 'hero-slider__content--full'; } else { echo ''; } ?>">
                                <?php if (!empty($item['title'])): ?> <?php if ($key == 0): ?>
                                ...
                                <?php endif; ?> <?php endif; ?> <?php if (!empty($item['subtitle'])): ?>
                                <h2 class="hero-slider__subtitle"><?php echo apply_filters('the_title', $item['subtitle']); ?></h2>
                                <?php endif; ?> <?php if (!empty($item['text'])): ?> <?php echo apply_filters('acf_the_content', str_replace('&nbsp;', ' ', $item['text'])); ?> <?php endif; ?> <?php if (!empty($item['button'])): ?>
