...
<div class="blank-button <?php if ($centered == 'true') { echo 'blank-button--centered'; } ?> <?php if ($background == 'true') { echo 'blank-button--background'; } ?>">
    ...
    <div class="container">
        <a href="<?php echo esc_html($button['url']); ?>" class="blank-button__button button" target="<?php echo esc_html($button['target']); ?>">
            ...
            <span class="button__icon button__icon--before"><?php echo wp_get_attachment_image($button_before_icon, 'full', '', [ 'loading' => 'eager', 'decoding' => 'async', ]); ?></span>
            <?php endif; ?> <?php echo esc_html($button['title']); ?> <?php if (!empty($button_after_icon)): ?>
            <span class="button__icon button__icon--after"><?php echo wp_get_attachment_image($button_after_icon, 'full', '', [ 'loading' => 'eager', 'decoding' => 'async', ]); ?></span>
            <?php endif; ?>
        </a>
    </div>
</div>
