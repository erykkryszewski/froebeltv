...
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
    ...
    <table cellspacing="0" class="shop_table shop_table_responsive">
        ...
        <?php endforeach; ?> <?php if (WC()->cart->needs_shipping() && WC()->cart->show_shipping()) : ?> <?php do_action('woocommerce_cart_totals_before_shipping'); ?> <?php wc_cart_totals_shipping_html(); ?> <?php do_action('woocommerce_cart_totals_after_shipping'); ?> <?php elseif (WC()->cart->needs_shipping() && 'yes' === get_option('woocommerce_enable_shipping_calc')) : ?>
        ...
        <?php endif; ?> <?php foreach (WC()->cart->get_fees() as $fee) : ?>
        <tr class="fee">
            <th>
        ...
        <?php } } ?> <?php do_action('woocommerce_cart_totals_before_order_total'); ?>
