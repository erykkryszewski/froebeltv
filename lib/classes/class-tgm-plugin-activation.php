    ...
    class TGM_Plugin_Activation
    {
        ...
        public function populate_file_path($plugin_slug = "")
        {
            if (
                ...
                $this->plugins[$plugin_slug]["file_path"] = $this->_get_plugin_basename_from_slug(
                    $plugin_slug,
                );
            } else {
                // Add file_path key for all plugins.
                foreach ($this->plugins as $slug => $values) {
                    $this->plugins[$slug]["file_path"] = $this->_get_plugin_basename_from_slug(
                        $slug,
                    );
                }
            }
        ...
        public function get_upgrade_notice($slug)
        {
            ...
            if (
                !empty($repo_updates->response[$this->plugins[$slug]["file_path"]]->upgrade_notice)
            ) {
